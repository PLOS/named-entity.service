...
--SELECT constraint_name INTO @journalTypeConstraint from information_schema.key_column_usage where constraint_schema='namedEntities' AND table_name='alerts' and column_name='journalTypeId';
--ALTER TABLE alerts DROP FOREIGN KEY @typeConstraint;
--ALTER TABLE alerts DROP FOREIGN KEY @journalTypeId;
