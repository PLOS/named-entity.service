...
class PlosNeglectedArticleBody(ArticleBody):
  """
  Model the PLoS Neglected Article page, article tab.
  """

  PROD_URL = 'http://journals.plos.org/plosntds/article?id=10.1371/journal.pntd.0002958'

  def __init__(self, driver):
    super(PlosNeglectedArticleBody, self).__init__(driver, random.choice(dois))
