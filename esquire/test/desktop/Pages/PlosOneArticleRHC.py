...
class PlosOneArticleRHC(ArticleRHC):
  """
  Model the PLoS One Article right hand column.
  """
  PROD_URL = 'http://journals.plos.org/plosone/article?id=10.1371/journal.pone.0000000'

  def __init__(self, driver):
    super(PlosOneArticleRHC, self).__init__(driver, random.choice(dois))

    # POM - Instance members

    # Locators - Instance members

    self._twitter_hashtag = '#PLOSONE'
