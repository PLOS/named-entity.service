...
class verify_Roles_ById(TestCase):


    # get /individuals/{nedId}/roles
    # List roles
    def getIndividualsRolesById(uri,id):
        uri=str(uri)
    ...
    def test_getIndividualsRolesById(self):
        #..................................................................
        ...
        for nedid in data_arry:
            endpointURL = getIndividualsRolesById(NedSrvURL,nedId)
