...
class verify_Degrees_ById(TestCase):


    # get /individuals/{nedId}/degrees
    # List degrees
    def getIndividualsDegreesById(uri,id):
        uri=str(uri)
    ...
    def test_getIndividualsDegreesById(self):
        #..................................................................
        ...
        for nedid in data_arry:
            endpointURL = getIndividualsDegreesById(NedSrvURL,nedId)
