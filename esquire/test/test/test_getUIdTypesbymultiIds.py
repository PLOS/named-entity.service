...
class verify_getUIdTypesByIdsbymultiIds(TestCase):

    def getUIdTypesByIds(uri,uidValue,uidTypeId):
        uri=str(uri)
    ...
    def test_getUIdTypesbymultiIds(self):
        #..................................................................
        # Here's where we build some context to our container applications

        sql="""select uni.typeId as uidType, uni.uniqueIdentifier as uidValue from uniqueIdentifiers uni, individualNames idn WHERE idn.nedId=uni.nedId;"""
        ckey="nedId"
        vkey='id'
        ...
        for key in data_model_as_dict:
            print("1")
        apiRequestURL=getUIdTypesByIds(uri,data_model_as_dict[key],key)
        assert apiRequestURL != None, "values"+str(data_model_as_dict[key])+" -"+str(key)
