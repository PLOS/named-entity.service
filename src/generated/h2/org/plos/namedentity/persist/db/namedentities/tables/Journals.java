...
public class Journals extends org.jooq.impl.TableImpl<org.plos.namedentity.persist.db.namedentities.tables.records.JournalsRecord> {
	...
	private static final long serialVersionUID = -1599363384;
	...
	public org.jooq.UniqueKey<org.plos.namedentity.persist.db.namedentities.tables.records.JournalsRecord> getPrimaryKey() {
		return org.plos.namedentity.persist.db.namedentities.Keys.CONSTRAINT_E;
	}
	...
	public java.util.List<org.jooq.UniqueKey<org.plos.namedentity.persist.db.namedentities.tables.records.JournalsRecord>> getKeys() {
		return java.util.Arrays.<org.jooq.UniqueKey<org.plos.namedentity.persist.db.namedentities.tables.records.JournalsRecord>>asList(org.plos.namedentity.persist.db.namedentities.Keys.CONSTRAINT_E);
	}
	...
	public java.util.List<org.jooq.ForeignKey<org.plos.namedentity.persist.db.namedentities.tables.records.JournalsRecord, ?>> getReferences() {
		return java.util.Arrays.<org.jooq.ForeignKey<org.plos.namedentity.persist.db.namedentities.tables.records.JournalsRecord, ?>>asList(org.plos.namedentity.persist.db.namedentities.Keys.CONSTRAINT_EF, org.plos.namedentity.persist.db.namedentities.Keys.CONSTRAINT_EFD);
	}
